...
const (
	AuditService_List_FullMethodName = "/baboflow.v1.AuditService/List"
)
...
type AuditServiceClient interface {
	// Old: GET /api/v1/audit?action=&userId=&page=&pageSize=.
	List(ctx context.Context, in *AuditLogListRequest, opts ...grpc.CallOption) (*AuditLogListResponse, error)
}
...
func (c *auditServiceClient) List(ctx context.Context, in *AuditLogListRequest, opts ...grpc.CallOption) (*AuditLogListResponse, error) {
...
func (UnimplementedAuditServiceServer) List(context.Context, *AuditLogListRequest) (*AuditLogListResponse, error) {
...
func _AuditService_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuditServiceServer).List(ctx, req.(*AuditLogListRequest))
	}
...
var AuditService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "baboflow.v1.AuditService",
	...
	Metadata: "baboflow/v1/audit.proto",
}
