...
const (
	AuthService_Login_FullMethodName          = "/baboflow.v1.AuthService/Login"
	AuthService_Logout_FullMethodName         = "/baboflow.v1.AuthService/Logout"
	AuthService_GetMe_FullMethodName          = "/baboflow.v1.AuthService/GetMe"
	AuthService_ChangePassword_FullMethodName = "/baboflow.v1.AuthService/ChangePassword"
)
...
func (c *authServiceClient) Logout(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*LogoutResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *authServiceClient) GetMe(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*User, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(User)
...
func (c *authServiceClient) ChangePassword(ctx context.Context, in *ChangePasswordRequest, opts ...grpc.CallOption) (*LogoutResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LogoutResponse)
...
func (UnimplementedAuthServiceServer) Logout(context.Context, *Empty) (*LogoutResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Logout not implemented")
}
func (UnimplementedAuthServiceServer) GetMe(context.Context, *Empty) (*User, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetMe not implemented")
}
func (UnimplementedAuthServiceServer) ChangePassword(context.Context, *ChangePasswordRequest) (*LogoutResponse, error) {
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "baboflow.v1.AuthService",
	...
	Metadata: "baboflow/v1/auth.proto",
}
